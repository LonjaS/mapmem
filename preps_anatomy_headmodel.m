...
headmodel_filename          = fullfile(save_dir, subject, 'preproc', [subject, '_headmodel' '.mat']);

mni_resliced_filename       = fullfile(save_dir, subject, 'preproc', [subject, '_mni_resliced' '.mgz']);
transform                   = fullfile(save_dir, subject, 'preproc', [subject, '_transform_vox2ctf.mat']);
load(transform);
