...
cd $SUBJECTS_DIR
cp -f $1/$2/$3_mni_resliced.mgz $SUBJECTS_DIR/$2/mri
cp -f $1/$2/$3_skullstrip.mgz $SUBJECTS_DIR/$2/mri

cd $SUBJECTS_DIR/$2/mri
mri_convert -c -oc 0 0 0 $1/$2/$3_mni_resliced.mgz orig.mgz
mri_convert -c -oc 0 0 0 $1/$2/$3_skullstrip.mgz brainmask.mgz
